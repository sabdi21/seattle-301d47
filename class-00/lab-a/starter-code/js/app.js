...
function displayPics(){
  ...
  // The error happens because 'rando' was locally and can't be called outside of the scope. I believe you could call the function 'makeRandom()' instead because it is assigned a value.
  // console.log(rando);
